...
<div class="flex flex-col items-center justify-center  p-8">
  ...
  <div className="relative grid grid-cols-1 sm:grid-cols-2 text-left gap-8 max-w-4xl mx-auto">
    ...
    <div className="absolute top-[calc(0%+3rem)] w-[calc(23%+15px)] h-[20px] border-t border-dashed border-purple-500 transform translate-y-[-50%] right-60 sm:block hidden"></div>
    <div className="absolute top-[calc(4%+3rem)] h-[58px] border-l border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(70%+2rem)] sm:block hidden"></div>
    ...
    <div className="absolute top-[calc(60%+6rem)] w-[calc(23%+14px)] h-[20px] border-t border-dashed border-purple-500 transform translate-y-[-50%] right-60 sm:block hidden"></div>
    <div className="absolute top-[calc(65%+6rem)] h-[60px] border-l border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(70%+2rem)] sm:block hidden"></div>

    <div className="absolute top-[calc(18%+10rem)] w-[calc(26%+16px)] h-[20px] border-t border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(20%+2rem)] sm:block hidden"></div>
    <div className="absolute top-[calc(15%+12rem)] h-[54px] border-l border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(20%+2rem)] sm:block hidden"></div>
  </div>
</div>
